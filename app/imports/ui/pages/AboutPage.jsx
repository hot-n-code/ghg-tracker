  ...
  render() {
    return (
        <Container className='centered'>
          <Grid.Row>
            <Header as='h1' className='centered'>At HEI, our family of Hawaii-based companies provides the energy and
              financial infrastructure that empowers much of the economic and community activity of our state.</Header>
            <Header size='tiny' className='centered'>Accelerating a Sustainable Future for Hawaii, Enhancing the Lives of Our Communities and Creating Value for Our Shareholders</Header>
          </Grid.Row>
          <Grid columns={3} divided>
            <Grid.Column>
              <Image src="/images/HE.png" centered/>
              <Header size='tiny'>For 130 years, Hawaiian Electric has provided the energy that fuels our islands growth and prosperity.
            ...
            <Grid.Column>
              ...
              <Header size='tiny'>American Savings Bank provides the capital to help Hawaii grow. It has been serving and investing in Hawaii’s families,
            ...
            <Grid.Column>
              ...
              <Header size='tiny'>Pacific Current is our newest subsidiary, and a powerful investment platform focused on accelerating
