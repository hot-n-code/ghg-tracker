...
class UserVSCumulative extends React.Component {
  ...
  renderPage() {
    ...
    if (thisMonthCO2Produced > 0 && (thisMonthCO2Reduced === 0 || thisMonthCO2Reduced < thisMonthCO2Produced)) {
            ...
            result = `Your CO2 reduction efforts are paying off! So far, you have 
            reduced ${thisMonthCO2Reduced.toFixed(2)} lbs of CO2. Keep up the good work!`;
        } else {
...
export default withTracker((selector, options) => {
    ...
    return {
        ...
        vehicles: UserVehicles.find({owner: currentUser}, options).fetch(),
        allVehicles: UserVehicles.find({}, options).fetch({}),
