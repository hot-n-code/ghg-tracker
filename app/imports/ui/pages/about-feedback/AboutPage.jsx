            ...
            <Container style={infoStyleTop}>
              <Grid columns={3} divided>
                <Grid.Column>
                  ...
                  <Button inverted id='hemore' color='green' content='Learn More' style={button} as={NavLink} activeClassName='active' exact to='/hemore'/>
                </Grid.Column>
                <Grid.Column>
                  ...
                  <Button inverted id='asbmore' color='green' content='Learn More' style={button} as={NavLink} activeClassName='active' exact to='/asbmore' />
                </Grid.Column>
                <Grid.Column>
                  ...
                  <Button inverted id='pcmore' color='green' content='Learn More' style={button} as={NavLink} activeClassName='active' exact to='/pcmore' />
                </Grid.Column>
              </Grid>
            </Container>
